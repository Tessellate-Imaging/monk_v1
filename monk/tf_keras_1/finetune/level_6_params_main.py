...
class prototype_params(finetune_state):
    ...
    @error_checks(None, model_name=None, freeze_base_network=None, use_gpu=None, gpu_memory_fraction=["gt", 0, "lt", 1],  
        use_pretrained=None, model_path=["file", 'r'], post_trace=False)
    @accepts("self", model_name=str, freeze_base_network=bool, use_gpu=bool, gpu_memory_fraction=float, use_pretrained=bool, model_path=[bool, str, list],  post_trace=False)
    #@TraceFunction(trace_args=True, trace_rv=True)
