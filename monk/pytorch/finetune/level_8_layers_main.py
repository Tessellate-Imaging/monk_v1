...
class prototype_layers(prototype_aux):
    ...
    #####################################################################################################################################
    @accepts("self", min_val=float, max_val=bool, post_trace=False)
    #@TraceFunction(trace_args=True, trace_rv=True)
    ...
    #####################################################################################################################################
    @accepts("self", lower=[int, float], upper=[int, float], final_layer=bool, post_trace=False)
    #@TraceFunction(trace_args=True, trace_rv=True)
    ...
    @accepts("self", threshold=[int, float], uid=[None, str], post_trace=False)
    #@TraceFunction(trace_args=True, trace_rv=True)
    ...
    #####################################################################################################################################
    @warning_checks(None, min_val=None, max_val=None, uid=None, post_trace=False)
    @error_checks(None, min_val=None, max_val=None, uid=None, post_trace=False)
    @accepts("self", min_val=[int, float], max_val=[int, float], uid=[None, str], post_trace=False)
    #@TraceFunction(trace_args=True, trace_rv=True)
    ...
    #####################################################################################################################################
    @warning_checks(None, lower=None, upper=None, uid=None, post_trace=False)
    @error_checks(None, lower=None, upper=None, uid=None, post_trace=False)
    @accepts("self", lower=[int, float], upper=[int, float], uid=[None, str], post_trace=False)
    #@TraceFunction(trace_args=True, trace_rv=True)
    ...
    #####################################################################################################################################
    @warning_checks(None, alpha=None, uid=None, post_trace=False)
    @error_checks(None, alpha=None, uid=None, post_trace=False)
    @accepts("self", alpha=[int, float], uid=[None, str], post_trace=False)
    #@TraceFunction(trace_args=True, trace_rv=True)
    ...
    #####################################################################################################################################
    @warning_checks(None, threshold=None, value=None, uid=None, post_trace=False)
    @error_checks(None, threshold=None, value=None, uid=None, post_trace=False)
    @accepts("self", threshold=[int, float], value=[int, float], uid=[None, str], post_trace=False)
    #@TraceFunction(trace_args=True, trace_rv=True)
