...
class prototype_optimizers(prototype_schedulers):
    ...
    def optimizer_sgd(self, learning_rate, momentum=0, dampening=0, weight_decay=0, nesterov=False):
        if(not nesterov):
            ...
            msg = "Nesterov triggers NAG optimizer.";
            ConstraintWarning(msg);
            self.system_dict = nag(self.system_dict , learning_rate, 
                momentum=momentum, dampening=dampening, weight_decay=weight_decay, nesterov=nesterov);
    ...
    @accepts("self", [int, float], momentum=[int, float], dampening=[int, float], weight_decay=[int, float], nesterov=bool, post_trace=True)
    @TraceFunction(trace_args=True, trace_rv=True)
    def optimizer_nag(self, learning_rate, momentum=0, dampening=0, weight_decay=0, nesterov=False):
        self.system_dict = nag(self.system_dict , learning_rate, 
            momentum=momentum, dampening=dampening, weight_decay=weight_decay, nesterov=nesterov);
    ...
    @TraceFunction(trace_args=True, trace_rv=True)
    def optimizer_adamax(self, learning_rate, betas=(0.9, 0.999), epsilon=1e-08, weight_decay=0.01):
    ...
    @accepts("self", [int, float], betas=tuple, epsilon=[int, float], weight_decay=[int, float], amsgrad=bool, post_trace=True)
    @TraceFunction(trace_args=True, trace_rv=True)
    def optimizer_nadam(self, learning_rate, betas=(0.9, 0.999), epsilon=1e-08, weight_decay=0, amsgrad=False):
    ...
    @accepts("self", [int, float], momentum=[int, float], dampening=[int, float], weight_decay=[int, float], nesterov=bool, post_trace=True)
    @TraceFunction(trace_args=True, trace_rv=True)
    def optimizer_signum(self, learning_rate, momentum=0, dampening=0, weight_decay=0, nesterov=False):
    ...
    @accepts("self", [int, float], betas=tuple, epsilon=[int, float], weight_decay=[int, float], amsgrad=bool, post_trace=True)
    @TraceFunction(trace_args=True, trace_rv=True)
    def optimizer_ftml(self, learning_rate, betas=(0.9, 0.999), epsilon=1e-08, weight_decay=0, amsgrad=False):
        self.system_dict = ftml(self.system_dict, learning_rate,
            betas=betas, epsilon=epsilon, weight_decay=weight_decay, amsgrad=amsgrad);
