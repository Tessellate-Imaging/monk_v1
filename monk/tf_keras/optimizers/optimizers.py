...
@accepts(dict, [int, float], rho=[int, float], epsilon=[int, float], weight_decay=[int, float], learning_rate_decay=[int, float], post_trace=True)
@TraceFunction(trace_args=False, trace_rv=False)
def adadelta(system_dict, learning_rate, rho=0.9, epsilon=1e-06, weight_decay=0, learning_rate_decay=0):
...
@accepts(dict, [int, float], betas=tuple, epsilon=[int, float], weight_decay=[int, float], amsgrad=bool, learning_rate_decay=[int, float], post_trace=True)
@TraceFunction(trace_args=False, trace_rv=False)
def adam(system_dict, learning_rate, betas=(0.9, 0.999), epsilon=1e-08, weight_decay=0, amsgrad=False, learning_rate_decay=0):
...
@accepts(dict, [int, float], betas=tuple, epsilon=[int, float], weight_decay=[int, float], learning_rate_decay=[int, float], post_trace=True)
@TraceFunction(trace_args=False, trace_rv=False)
def adamax(system_dict, learning_rate, betas=(0.9, 0.999), epsilon=1e-08, weight_decay=0.01, learning_rate_decay=0):
...
@accepts(dict, [int, float], alpha=[int, float], epsilon=[int, float], weight_decay=[int, float], momentum=[int, float], centered=bool, 
    learning_rate_decay=[int, float], post_trace=True)
@TraceFunction(trace_args=False, trace_rv=False)
def rmsprop(system_dict, learning_rate, alpha=0.99, epsilon=1e-08, weight_decay=0, momentum=0, centered=False, learning_rate_decay=0):
...
@accepts(dict, [int, float], momentum=[int, float], dampening=[int, float], weight_decay=[int, float], nesterov=bool, 
    learning_rate_decay=[int, float], post_trace=True)
@TraceFunction(trace_args=False, trace_rv=False)
def sgd(system_dict, learning_rate, momentum=0, dampening=0, weight_decay=0, nesterov=False, learning_rate_decay=0):
...
@accepts(dict, [int, float], betas=tuple, epsilon=[int, float], weight_decay=[int, float], learning_rate_decay=[int, float], post_trace=True)
@TraceFunction(trace_args=False, trace_rv=False)
def nadam(system_dict, learning_rate, betas=(0.9, 0.999), epsilon=1e-08, weight_decay=0.01, learning_rate_decay=0):
