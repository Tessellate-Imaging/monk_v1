...
models = [["resnet18_v1", True, True], ["resnet34_v1", False, True], ["resnet50_v1", True, False]];  
...
optimizers = ["sgd", "adam", "nadam", "adagrad", "signum"];   #Model name, learning rate
